...
I felt it doesn't make sense to be standalone . I was thinking of having an api for it which 
takes the orderId as path parameter and the fees as RequestBody
, but i enough wit test cases 
